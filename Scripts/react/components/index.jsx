class NameForm extends React.Component {
     ...
     * 
     * @param {string}
     * Make a get request to the Github API and map the returned results to state.repos.
     */
    handleSubmit(event) {
        ...
        if (this.state.searchTerm === "") {
            ...
            axios.get("https://api.github.com/search/repositories?q=" + this.state.searchTerm + "&page=" + this.state.pageNum)
                .then(response => {this.setState({ repos: [] });
            ...
            <div>
                <form onSubmit={this.handleSubmit} className="mt-5 form-inline col-12">
                    <header className="mb-3">
                        <h1 className="display-3">Search Github Repositorie's</h1>
                        ...
                        {this.state.validationError ? <span className="text-danger d-flex flex-column">Please Type in at least 1 charecter</span> : ''}
                    </header>
                </form>
                <div className="row">
